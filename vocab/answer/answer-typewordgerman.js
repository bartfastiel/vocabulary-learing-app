// vocab/answer/answer-typewordgerman.js
//
// Answer mode where the user types the German translation
// for a shown English word. Mirrors the typewordenglish mode exactly.
//

class VocabAnswerTypeWordGerman extends HTMLElement {
    constructor() {
        super();
    ...
    `;
        ...
        // Auto-focus when user types any letter
        document.body.addEventListener("keydown", function initType(e) {
            if (!input.disabled && /^[a-zA-ZäöüÄÖÜß]$/.test(e.key)) {
                input.focus();
...
customElements.define("vocab-answer-typewordgerman", VocabAnswerTypeWordGerman);
